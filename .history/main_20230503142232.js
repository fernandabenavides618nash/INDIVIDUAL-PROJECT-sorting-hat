...
const start = () => {
  const initialScreen = '<div><h1>Welcome to Hogwarts</h1></div><div><h4>Let the Sorting Hat assign you to one of the houses</h4></div><button type="button" class="btn btn-outline-secondary">Put on The Hat</button>'
...
form.addEventListener('sort', sorting);
